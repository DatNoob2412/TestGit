	...
	class CR_Shortcodes_Settings {
		...
		*/
		...
		public function show_shortcodes( $value ) {
			...
			'<li>' . sprintf( __( '%1$s argument accepts %2$s or a comma-separated list of product IDs. Use this argument to show reviews of the current product only or reviews corresponding to product IDs from the comma-separated list.', 'customer-reviews-woocommerce' ), '<code>products</code>', '<code>"current"</code>' ) . '</li>' .
